...
try:
    ...
    if not os.path.exists(samseg_path + "seg.mgz"):
        ...
        os.system("export FREESURFER_HOME=/usr/local/freesurfer/7.3.0; run_samseg -i " + os.path.join(scratch_dir,"mean_b0.nii.gz") + " -o " + samseg_path + " --threads 10")
    ...
    if not os.path.exists(os.path.join(scratch_dir,"wmfod.mif")):
        if not single_shell:
            ...
            os.system("dwi2fod csd " + os.path.join(scratch_dir,"dwi.mif") + " " + os.path.join(scratch_dir,"wm.txt") + " " + os.path.join(scratch_dir,"wmfod.mif") + " -mask " + os.path.join(scratch_dir,"brain_mask.mif") + " -lmax 6 -force -nthreads 80 -quiet")
    print("done")
