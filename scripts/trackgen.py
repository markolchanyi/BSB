...
try:
    ...
    if not os.path.exists(os.path.join(scratch_dir,"dwi.mif")) and not fsl_preprocess:
        os.system("mrconvert " + os.path.join(scratch_dir,"data.nii.gz") + " " + os.path.join(scratch_dir,"dwi.mif") + " -fslgrad " + os.path.join(scratch_dir,"dwi.bvec") + " " + os.path.join(scratch_dir,"dwi.bval") + " -nthreads " + str(num_threads) + " -quiet -force")
    ...
    os.system("mrinfo -json_all " + os.path.join(scratch_dir,"header.json") + " " + os.path.join(scratch_dir,"dwi.mif") + " -quiet -force")
    ...
    if (vox_resolution > 1.05) or (vox_resolution < 0.95):
        ...
        os.system("mrgrid " + os.path.join(scratch_dir,"dwi.mif") + " regrid -vox 1.0 " + os.path.join(scratch_dir,"dwi_regridded_1mm.mif") + " -quiet -force")
    ...
    if not os.path.exists(os.path.join(scratch_dir,"mean_b0.mif")):
        os.system("dwiextract " + os.path.join(scratch_dir,"dwi.mif") + " - -bzero | mrmath - mean " + os.path.join(scratch_dir,"mean_b0.mif") + " -axis 3 -force -quiet")
        ...
        os.system("mrconvert " + os.path.join(scratch_dir,"mean_b0.mif") + " " + os.path.join(scratch_dir,"mean_b0.nii.gz") + " -datatype float32 -force -quiet")
        ## calculate all scalar volumes from tensor fit and move to output
        os.system("dwi2tensor " + os.path.join(scratch_dir,"dwi.mif") + " " + os.path.join(scratch_dir,"dwi_dt.mif") + " -nthreads " + str(num_threads) + " -force -quiet")
        os.system("tensor2metric " + os.path.join(scratch_dir,"dwi_dt.mif") + " -fa " + os.path.join(output_dir,"fa_1mm.nii.gz") + " -ad " + os.path.join(output_dir,"ad_1mm.nii.gz") + "  -rd " + os.path.join(output_dir,"rd_1mm.nii.gz") + " -vector " + os.path.join(output_dir,"v1_1mm.nii.gz") + " -value " + os.path.join(output_dir,"l1_1mm.nii.gz") + " -force -quiet")
    ...
    if not os.path.exists(samseg_path + "seg.mgz"):
        os.system("export FREESURFER_HOME=/usr/local/freesurfer/7.3.2; mri_synthseg --i " + os.path.join(scratch_dir,"mean_b0.nii.gz") + " --o " + samseg_path + " --threads " + str(num_threads) + " > " + os.path.join(scratch_dir,"log.txt"))
    ...
    os.system("segment_subregions brainstem --out-dir=" + os.path.join(scratch_dir,"brainstem_subfields") + " --cross " + os.path.join(scratch_dir,"fs_subj_dir") + " --threads 80" + " > " + os.path.join(scratch_dir,"log.txt"))
    ...
    os.system("mri_binarize --noverbose --i " + os.path.join(samseg_path,"seg.mgz ") + " --o " + os.path.join(scratch_dir,"DC.nii") + " --match " + str(DC_labels[0]) + " " + str(DC_labels[1]) + " > " + os.path.join(scratch_dir,"log.txt"))
    os.system("mri_binarize --noverbose --i " + os.path.join(samseg_path,"seg.mgz ") + " --o " + os.path.join(scratch_dir,"cort.nii") + " --match " + str(cort_labels[0]) + " " + str(cort_labels[1]) + " > " + os.path.join(scratch_dir,"log.txt"))
    os.system("mri_binarize --noverbose --i " + os.path.join(samseg_path,"seg.mgz ") + " --o " + os.path.join(scratch_dir,"thal.nii") + " --match " + str(thal_labels[0]) + " " + str(thal_labels[1]) + " > " + os.path.join(scratch_dir,"log.txt"))
    os.system("mri_binarize --noverbose --i " + os.path.join(samseg_path,"seg.mgz ") + " --o " + os.path.join(scratch_dir,"CB.nii") + " --match " + str(CB_labels[0]) + " " + str(CB_labels[1]) + " > " + os.path.join(scratch_dir,"log.txt"))
    os.system("mri_binarize --noverbose --i " + os.path.join(samseg_path,"seg.mgz ") + " --o " + os.path.join(scratch_dir,"brainstem.nii") + " --match " + str(brainstem_label) + " > " + os.path.join(scratch_dir,"log.txt"))
    os.system("mri_binarize --noverbose --i " + os.path.join(scratch_dir,"brainstem_subfields","brainstemSsLabels.FSvoxelSpace.mgz") + " --o " + os.path.join(scratch_dir,"midbrain.nii") + " --match " + str(midbrain_label) + " > " + os.path.join(scratch_dir,"log.txt"))
    os.system("mri_binarize --noverbose --i " + os.path.join(scratch_dir,"brainstem_subfields","brainstemSsLabels.FSvoxelSpace.mgz") + " --o " + os.path.join(scratch_dir,"pons.nii") + " --match " + str(pons_label) + " > " + os.path.join(scratch_dir,"log.txt"))
    os.system("mri_binarize --noverbose --i " + os.path.join(scratch_dir,"brainstem_subfields","brainstemSsLabels.FSvoxelSpace.mgz") + " --o " + os.path.join(scratch_dir,"medulla.nii") + " --match " + str(medulla_label) + " > " + os.path.join(scratch_dir,"log.txt"))
    print("done")
    ...
    os.system("mri_binarize --noverbose --i " + os.path.join(samseg_path,"seg.mgz") + " --o " + os.path.join(scratch_dir,'thal_brainstem_union.mgz') + " --match " + str(brainstem_label) + " " + str(thal_labels[0]) + " " + str(thal_labels[1]) + " > " + os.path.join(scratch_dir,"log.txt"))
    os.system("mri_binarize --noverbose --i " + os.path.join(samseg_path,"seg.mgz ") + " --o " + os.path.join(scratch_dir,"all_labels.nii") + " --match " + str(thal_labels[0]) + " " + str(thal_labels[1]) + " " + str(DC_labels[0]) + " " + str(DC_labels[1]) + " " + str(CB_labels[0]) + " " + str(CB_labels[1]) + " " + str(brainstem_label) + " > " + os.path.join(scratch_dir,"log.txt"))
    ...
    if not os.path.exists(os.path.join(scratch_dir,"brain_mask.mif")):
        os.system("/usr/pubsw/packages/mrtrix/dev_230511/bin/dwi2mask synthstrip " + os.path.join(scratch_dir,"dwi.mif") + " " + os.path.join(scratch_dir,"brain_mask.mif") + " -fslgrad " + os.path.join(scratch_dir,"dwi.bvec") + " " + os.path.join(scratch_dir,"dwi.bval") + " -nthreads " + str(num_threads) + " -quiet -force")
    ...
    if not os.path.exists(os.path.join(scratch_dir,"brainstem.mif")) or not os.path.exists(os.path.join(scratch_dir,"CB.mif")) or not os.path.exists(os.path.join(scratch_dir,"DC.mif")) or not os.path.exists(os.path.join(scratch_dir,"thal.mif")):
        os.system("mrconvert " + os.path.join(scratch_dir,"thal.nii") + " " + os.path.join(scratch_dir,"thal.mif") + " -quiet -force")
        os.system("mrconvert " + os.path.join(scratch_dir,"DC.nii") + " " + os.path.join(scratch_dir,"DC.mif") + " -quiet -force")
        os.system("mrconvert " + os.path.join(scratch_dir,"cort.nii") + " " + os.path.join(scratch_dir,"cort.mif") + " -quiet -force")
        os.system("mrconvert " + os.path.join(scratch_dir,"CB.nii") + " " + os.path.join(scratch_dir,"CB.mif") + " -quiet -force")
        os.system("mrconvert " + os.path.join(scratch_dir,"brainstem.nii") + " " + os.path.join(scratch_dir,"brainstem.mif") + " -quiet -force")
        os.system("mrconvert " + os.path.join(scratch_dir,"midbrain.nii") + " " + os.path.join(scratch_dir,"midbrain.mif") + " -quiet -force")
        os.system("mrconvert " + os.path.join(scratch_dir,"pons.nii") + " " + os.path.join(scratch_dir,"pons.mif") + " -quiet -force")
        os.system("mrconvert " + os.path.join(scratch_dir,"medulla.nii") + " " + os.path.join(scratch_dir,"medulla.mif") + " -quiet -force")
        ...
        os.system("maskfilter " + os.path.join(scratch_dir,"DC.mif") + " dilate -npass " + str(morpho_amount+1) + " " + os.path.join(scratch_dir,"DC.mif") + " -quiet -force")
        os.system("maskfilter " + os.path.join(scratch_dir,"cort.mif") + " dilate -npass " + str(morpho_amount+2) + " " + os.path.join(scratch_dir,"cort.mif") + " -quiet -force")
        os.system("maskfilter " + os.path.join(scratch_dir,"thal.mif") + " dilate -npass " + str(morpho_amount) + " " + os.path.join(scratch_dir,"thal.mif") + " -quiet -force")
        os.system("maskfilter " + os.path.join(scratch_dir,"CB.mif") + " erode -npass " + str(morpho_amount) + " " + os.path.join(scratch_dir,"CB.mif") + " -quiet -force")
        os.system("maskfilter " + os.path.join(scratch_dir,"medulla.mif") + " dilate -npass " + str(morpho_amount-1) + " " + os.path.join(scratch_dir,"medulla.mif") + " -quiet -force")
        os.system("maskfilter " + os.path.join(scratch_dir,"pons.mif") + " erode -npass " + str(morpho_amount+1) + " " + os.path.join(scratch_dir,"pons.mif") + " -quiet -force")
        os.system("mrcalc " + os.path.join(scratch_dir,"DC.mif") + " " + os.path.join(scratch_dir,"cort.mif") + " -mult " + os.path.join(scratch_dir,"DC.mif") + " -quiet -force")
        print("done")
    ...
    #if not os.path.exists(os.path.join(scratch_dir,"tracts_thal_rev.tck")):
     #   print("starting rev tracking on thal.mif")
        #os.system("tckgen -algorithm iFOD2 -angle 50 -select 100000 -seed_image " + os.path.join(scratch_dir,"pons.mif") + " -include " + os.path.join(scratch_dir,"thal.mif") + " " + os.path.join(scratch_dir,"wmfod_norm.mif") + " " + os.path.join(scratch_dir,"tracts_thal_rev.tck") + " -mask " + os.path.join(scratch_dir,'tractography_mask.nii.gz') + " -max_attempts_per_seed 750 -trials 750 -cutoff 0.1 -maxlength 200 -step 0.5  -force -nthreads 80")
    #if not os.path.exists(os.path.join(scratch_dir,"tracts_DC_rev.tck")):
     #   print("starting rev tracking on DC.mif")
        #os.system("tckgen -algorithm iFOD2 -angle 50 -select 100000 -seed_image " + os.path.join(scratch_dir,"pons.mif") + " -include " + os.path.join(scratch_dir,"pons.mif") + " -include " + os.path.join(scratch_dir,"DC.mif") + " -exclude " + os.path.join(scratch_dir,"CB.mif") + " " + os.path.join(scratch_dir,"wmfod_norm.mif") + " " + os.path.join(scratch_dir,"tracts_DC_rev.tck") + " -mask " + os.path.join(scratch_dir,'tractography_mask.nii.gz') + " -max_attempts_per_seed 750 -trials 750 -cutoff 0.1 -maxlength 200 -step 0.5 -force -nthreads 80")
    #if not os.path.exists(os.path.join(scratch_dir,"tracts_CB_rev.tck")):
     #   print("starting rev tracking on CB.mif")
        #os.system("tckgen -algorithm iFOD2 -angle 50 -select 50000 -seed_image " + os.path.join(scratch_dir,"DC.mif") + " -include " + os.path.join(scratch_dir,"DC.mif") +  " -exclude " + os.path.join(scratch_dir,"medulla.mif") + " " + os.path.join(scratch_dir,"wmfod_norm.mif") + " " + os.path.join(scratch_dir,"tracts_CB_rev.tck") + " -mask " + os.path.join(scratch_dir,'tractography_mask.nii.gz') + " -max_attempts_per_seed 750 -trials 750 -cutoff 0.1 -maxlength 200 -step 0.5 -force -nthreads 80")
    ...
    #if not os.path.exists(os.path.join(scratch_dir,"tracts_DC_rev.mif")):
    #    os.system("tckmap " + os.path.join(scratch_dir,"tracts_DC_rev.tck") + " -template " + os.path.join(scratch_dir,"mean_b0.mif") + " -contrast tdi " + os.path.join(scratch_dir,"tracts_DC_rev.mif") + " -force")
    #if not os.path.exists(os.path.join(scratch_dir,"tracts_CB_rev.mif")):
    #    os.system("tckmap " + os.path.join(scratch_dir,"tracts_CB_rev.tck") + " -template " + os.path.join(scratch_dir,"mean_b0.mif") + " -contrast tdi " + os.path.join(scratch_dir,"tracts_CB_rev.mif") + " -force")
    ...
    print_no_newline("linearly matching tract histograms...")
    os.system("mrhistmatch linear " + os.path.join(scratch_dir,"tracts_CB.mif") + " " + os.path.join(scratch_dir,"tracts_thal.mif") + " " + os.path.join(scratch_dir,"tracts_CB_matched.mif") + " -quiet -force")
    os.system("mrhistmatch linear " + os.path.join(scratch_dir,"tracts_DC.mif") + " " + os.path.join(scratch_dir,"tracts_thal.mif") + " " + os.path.join(scratch_dir,"tracts_DC_matched.mif") + " -quiet -force")
    print("done")
    ...
    os.system("mrcalc " + os.path.join(scratch_dir,"tracts_CB_matched.mif") + " 8 -mult " + os.path.join(scratch_dir,"tracts_CB_matched.mif") + " -quiet -force")
    os.system("mrcalc " + os.path.join(scratch_dir,"tracts_DC_matched.mif") + " 5 -mult " + os.path.join(scratch_dir,"tracts_DC_matched.mif") + " -quiet -force")
    ...
    ### turn into color map
    os.system("mrcat " + os.path.join(scratch_dir,"tracts_thal.mif") + " " + os.path.join(scratch_dir,"tracts_CB_matched.mif") + " " + os.path.join(scratch_dir,"tracts_DC_matched.mif") + " " + os.path.join(scratch_dir,"tracts_concatenated.mif") + " -quiet -force")
    os.system("mrcolour " + os.path.join(scratch_dir,"tracts_concatenated.mif") + " rgb " + os.path.join(scratch_dir,"tracts_concatenated_color.mif") + " -quiet -force")
